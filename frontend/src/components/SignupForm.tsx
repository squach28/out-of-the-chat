...
const SignupForm = () => {
    ...
    return (
        <form className="flex flex-col p-4 gap-2" action="">
            ...
            <input id="password" name="password" className={`border p-1`} type="password" onChange={onInputChange} placeholder="6 characters or longer" />
            <label htmlFor="confirmPassword" className="font-bold">Confirm Password <span className="text-red-400">*</span></label>
            <input id="confirmPassword" name="confirmPassword" className={`border p-1`} type="password" onChange={onInputChange} placeholder="Must match password" />
